<script>
  ...
  import {menuOption} from 'stores/store.js'
    ...
    >
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none">
        ...
        <li class="items-center">
          <a
            use:link
            href="/admin/externalDashboard"
            class="text-xs uppercase py-3 font-bold block {location.href.indexOf('/admin/externalDashboard') !== -1 ? 'text-red-500 hover:text-red-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
              class="fas fa-tv mr-2 text-sm {location.href.indexOf('/admin/externalDashboard') !== -1 ? 'opacity-75' : 'text-blueGray-300'}"
            ></i>
           External Dashboard
          </a>
        </li>
        <li class="items-center">
          ...
          >
            <i
              class="fas fa-tv mr-2 text-sm {location.href.indexOf('/admin/tables') !== -1 ? 'opacity-75' : 'text-blueGray-300'}"
            ></i>
            Invoices
          </a>
        </li>
     ...
     <ul class="md:flex-col md:min-w-full flex flex-col list-none">
       <li class="items-center">
         ...
         >
           <i
             class="far fa-file-alt mr-2 text-sm {location.href.indexOf('/admin/report') !== -1 ? 'opacity-75' : 'text-blueGray-300'}"
           ></i>
