<script>
  ...
  let title = "Dashboard Menu Group";
  let documentdata = document;
  let dataLabels = [];
  let showMenuGroup = false;
  let showToastSuccess = false;
  let showNotification = false;
  let messageNotification = "";
  let showBusyIndicator = false;
  let searchGroupName = "";
  let columns = ["Group Name", "Icon", "Order", "Status", "Date", "Updated By"];
  let search = new proto.chat.Search();
  let menuGroupList = [];
  let token = localStorage.getItem("token");
  let MenuGroupSelected = {};
  let dataButtons = [];
  ...
  function searchMenuGroup() {
    var q = {}; // declare the query object
    q["$and"] = [];

    if (searchGroupName != "") {
      var cond = { $regex: searchGroupName, $options: "i" };
  ...
  function goToMenuGroup(itemMenuGroup) {
    setTimeout(() => {
      MenuGroupSelected = {
        groupSelected: itemMenuGroup,
        hasData: true,
  ...
  function sentToExcelFile() {
    ...
    showBusyIndicator = exportToSpreadsheet(dataExport, "MenuGroup");
  }
        ...
        <div class="w-full lg:w-9/12 px-4">
          <div class="relative w-full mb-3">
            <label
              ...
              id="lSearchByGroupName"
              for="iSearchGroupName"
            >
              {$_("Search By Group Name")}
            </label>
            {#if searchGroupName != ""}
              <ClearIcon
                on:click={() => {
            ...
            <div class="text-center flex justify-between">
              ...
              <div style="margin-top: 20px;">
                ...
                <button
                  ...
                  id="bAddNewMenuGroup"
                  on:click|preventDefault={addNewMenuGroup}
                >
